        ...
        <div className="space-y-5 xl:space-x-2">
          {allDecorator.length === 0 ? (
            ...
            allDecorator.map((d, i) => (
              <div
                key={d._id}
                className="flex flex-col xl:flex-row xl:items-center xl:justify-between bg-primary text-secondary rounded-lg shadow-xl p-2 text-lg md:text-xl"
              >
                {/* SL */}
                ...
                <div className="flex justify-between xl:w-[120px] px-2 py-2 border-b border-gray-300 xl:border-b-0">
                  ...
                  <span className="px-2 py-1 rounded-xl text-center xl:w-full  bg-green-500 text-white">
                    {d.status}
                  </span>
                </div>
